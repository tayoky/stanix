...
#define IOAPIC_DEST_MODE            0x01000
#define IOAPIC_DELIVERY_STATUS      0x02000
#define IOAPIC_PIN_POLARITY         0x04000
#define IOAPIC_PIN_POLARITY_HIGH    0x00000
#define IOAPIC_PIN_POLARITY_LOW     0x04000
#define IOAPIC_REMOTE_IRR           0x08000
#define IOAPIC_TRIGGER_MODE         0x10000
#define IOAPIC_TRIGGER_MODE_EDGE    0x00000
#define IOAPIC_TRIGGER_MODE_LEVEL   0x10000
#define IOAPIC_MASK                 0x20000
